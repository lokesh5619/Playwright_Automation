...
test('facebookLogin',async({page}) => {
    ...
    await page.locator("//input[@id='_R_1h6kqsqppb6amH1_' and @name='email']").fill('Lokesh vishwakarma');

    await page.locator("//input[@name='pass' and @type='password']").fill('626365');
